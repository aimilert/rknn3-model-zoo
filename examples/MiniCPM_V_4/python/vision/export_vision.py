...
if __name__ == '__main__':
    ...
    if args.quant and torch.cuda.is_available():
        ...
        ## 量化工具加载模型
        ret = QuantTool.load_model(model=model.vpm, tokenizer=None, device='cuda')
        if ret != 0:
        ...
        model.vpm = QuantTool.quantize(quantized_dtype="w4a16", quantized_method="group32", quantized_algorithm="grq", dataset=dataset)
