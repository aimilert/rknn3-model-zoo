...
#ifndef _RKNN_DEMO_QWEN3_ASR_LLM_UTILS_H_
#define _RKNN_DEMO_QWEN3_ASR_LLM_UTILS_H_

#include "rknn3_api.h"
#include "Tokenizer.h"
#include "common.h"

#define MAX_NEW_TOKENS 1024*6
#define MAX_CONTEXT_LEN 1024*24
...
int inference_qwen3_asr_llm(rknn_qwen3_asr_llm_context* llm_ctx, rknn3_llm_tensor tensor, int n_inputs, rknn_perf_metrics_t* perf);

int inference_qwen3_asr_llm_ex(rknn_qwen3_asr_llm_context* llm_ctx,
...
#endif //_RKNN_DEMO_QWEN3_ASR_LLM_UTILS_H_
