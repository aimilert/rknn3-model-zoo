...
DEFAULT_ONNX_PATH = '../../../models/encoder.onnx'
DEFAULT_RKNN_PATH = '../../../models/encoder.rknn'
DEFAULT_QUANT = False

def parse_arg():
    parser = ArgumentParser(description='Export Qwen3-ASR audio encoder to RKNN model')
    ...
    parser.add_argument('--config', type=str, default=None, help='optional JSON file path for rknn.config overrides')
