...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="Export ByteDance-Seed/UI-TARS-2B-SFT vision configuration and onnx model for RKNN")
    parser.add_argument("--model_path", type=str, help="model path or name", required=False, default="ByteDance-Seed/UI-TARS-2B-SFT")
    parser.add_argument("--export_vision_path", type=str, help="export vision onnx model path", required=False, default="../../model/vision/UI-TARS-2B-SFT-vision.onnx")
