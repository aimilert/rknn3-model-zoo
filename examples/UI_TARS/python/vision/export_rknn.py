...
ONNX_MODEL = '../../model/vision/UI-TARS-2B-SFT-vision.onnx'
RKNN_MODEL = '../../model/vision/UI-TARS-2B-SFT-vision.rknn'
DATASET_PATH = None
...
def load_config(config_path: str):
    ...
    if not os.path.exists(config_path):
        return 448, 448, np.array([[1,32,32]], dtype=np.int64)
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="UI-TARS-2B-SFT vision convert rknn") 
