...
#ifndef _RKNN_DEMO_GLM_LLM_UTILS_H_
#define _RKNN_DEMO_GLM_LLM_UTILS_H_
...
int inference_glm_llm(rknn_glm_llm_context* llm_ctx, rknn3_llm_tensor inputs, int n_inputs, rknn_perf_metrics_t* perf);

#endif //_RKNN_DEMO_GLM_LLM_UTILS_H_