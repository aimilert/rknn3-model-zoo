...
| M5 板端网关（**已入库**）演进 | `examples/multicard/serve/rkllm_gateway.py` | M5 入库 `db3fe3d` = `e09ac2b941de767443c0d1d635bd305b` → 修坑 4 `213a131` = `1eb4347a3aae6ec9e69e0f624bdaf62e` → 加网页演示 `570c406` = `a7dde57a99cdb89d343e3f984000cec6` → 多用户版 `bc7f013` = `f35fd2b84ec9968d83795c70cc3d6e0d` → **修 ERR 帧解析 `bc92ccb` = `fcb9dcd3b15bf26190d142296055593c`（当前 HEAD）**（本行 md5 **2026-09-16 逐版本重算过，都对**） |
...
**⚠️ 帧协议的一个硬缺陷：`ERR` 被按 `DELTA` 解析（2026-09-16 板上撞到，已修 `bc92ccb`）**
