...
#   <hash>   multicard/serve: move off 8080, close CORS by default, and fit the page to one screen  (v1.25；§9.20)
...
（`192.168.31.246:8080` → 本地 `127.0.0.1:18082` 里的 `8080` 那半）、cc-switch 的
Base URL（`http://192.168.31.246:8080`）、浏览器书签。
