...
int inference_hunyuan_llm(rknn_hunyuan_llm_context* llm_ctx, rknn3_llm_tensor tensor, int n_inputs, rknn_perf_metrics_t* perf)
{
    ...
    // Run
    printf("rknn_session_run for Hunyuan model\n");
