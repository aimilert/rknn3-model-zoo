...
#ifndef _RKNN_DEMO_GME_QWEN_VL_LLM_UTILS_H_
#define _RKNN_DEMO_GME_QWEN_VL_LLM_UTILS_H_
...
int release_gme_qwen_vl_llm(rknn_gme_qwen_vl_llm_context* llm_ctx);

#endif //_RKNN_DEMO_GME_QWEN_VL_LLM_UTILS_H_