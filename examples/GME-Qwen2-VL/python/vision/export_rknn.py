...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="GmeQwen2VL vision convert rknn") 
    ...
    # rknn.accuracy_analysis(inputs=["/data0/share/wyd/pic/TaobaoCity_Alibaba_Xixi_Park_448.jpg"])
    if ret != 0:
