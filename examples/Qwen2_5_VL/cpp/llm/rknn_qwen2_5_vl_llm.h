...
#ifndef _RKNN_DEMO_QWEN2_5_VL_LLM_UTILS_H_
#define _RKNN_DEMO_QWEN2_5_VL_LLM_UTILS_H_
...
int inference_qwen2_5_vl_llm(rknn_qwen2_5_vl_llm_context* llm_ctx, rknn3_llm_multimodal_tensor tensor, int n_inputs, rknn_perf_metrics_t* perf);

#endif //_RKNN_DEMO_QWEN2_5_VL_LLM_UTILS_H_
