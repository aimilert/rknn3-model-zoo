...
#ifndef _RKNN_DEMO_JANUS_LLM_UTILS_H_
#define _RKNN_DEMO_JANUS_LLM_UTILS_H_
...
int release_janus_llm(rknn_janus_llm_context* llm_ctx);

int inference_janus_llm(rknn_janus_llm_context* llm_ctx, rknn3_llm_multimodal_tensor tensor, int n_inputs, rknn_perf_metrics_t* perf);

#endif //_RKNN_DEMO_JANUS_LLM_UTILS_H_