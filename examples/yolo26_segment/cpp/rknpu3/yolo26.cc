...
int inference_yolo26_model(rknn_app_context_t *app_ctx, image_buffer_t *img, object_detect_result_list *od_results, double* inter_time, float nms_thresh, float box_thresh)
{
    int ret = 0;
    ...
    double Input_sync_time = 0.0;
    double Output_sync_time = 0.0;
