...
ONNX_MODEL = '../model/llm/MiniCPM5-1B.onnx'
LLM_CONFIG = '../model/llm/MiniCPM5-1B.config.pkl'
RKNN_MODEL = '../model/llm/MiniCPM5-1B.rknn'
DATASET_PATH = None

if __name__ == '__main__':

    from argparse import ArgumentParser
    parser = ArgumentParser(description="Export openbmb/MiniCPM5 llm to RKNN model") 
