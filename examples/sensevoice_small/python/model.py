# modified from https://github.com/modelscope/FunASR/blob/main/funasr/models/sense_voice/model.py
...
class SenseVoiceEncoderSmall(nn.Module):
    ...
    def onnx_forward(self, xs_pad: torch.Tensor, masks: torch.Tensor):
