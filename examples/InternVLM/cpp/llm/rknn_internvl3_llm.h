...
#ifndef _RKNN_DEMO_INTERNVL3_LLM_UTILS_H_
#define _RKNN_DEMO_INTERNVL3_LLM_UTILS_H_
...
int inference_internvl3_llm(rknn_internvl3_llm_context* llm_ctx, rknn3_llm_multimodal_tensor tensor, int n_inputs, rknn_perf_metrics_t* perf);

#endif //_RKNN_DEMO_INTERNVL3_LLM_UTILS_H_